...
fn translate_command_key(buf: &CommandBuffer, key: KeyEvent) -> Option<Action> {
    ...
    match key.code {
        ...
        KeyCode::Tab if popover_open => Some(Action::Command(CommandAction::CompletionAccept { submit: false })),
        ...
        KeyCode::Enter if popover_open => Some(Action::Command(CommandAction::CompletionAccept { submit: true })),
